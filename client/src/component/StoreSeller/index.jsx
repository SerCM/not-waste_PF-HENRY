  ...
  const redirigir = (tipo) => {
    ...
    if (tipo === "manager")
      return (
        <div>
          <h2>
            Esta seccion muestra las publicaciones realizadas por cada uno de
            sus vendedores.
          </h2>
          <br />
          <h4>
            Su usuario "Adminitrador" no tiene datos para mostrar en esta
    ...
    if (tipo === "customer")
      return (
        <div>
          <h2>Esta seccion es para vendedores</h2>
          <br />
